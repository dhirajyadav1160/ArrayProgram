...
public class EmployeeFreeTime {
  ...
  public static void main(String[] args) {
    List<List<Interval>> schedule = new ArrayList<List<EmployeeFreeTime.Interval>>();
    List<Interval> ints1 = new ArrayList<EmployeeFreeTime.Interval>();
    ints1.add(new Interval(45, 56));
    ints1.add(new Interval(89, 96));

    List<Interval> ints3 = new ArrayList<EmployeeFreeTime.Interval>();
  ...
  public List<Interval> employeeFreeTime(List<List<Interval>> schedule) {
    if (schedule.isEmpty()) return new ArrayList<EmployeeFreeTime.Interval>();
    ...
    List<Interval> result = new ArrayList<EmployeeFreeTime.Interval>();
